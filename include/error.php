<?  function exception_handler($e) {
	...
	switch ($e->getCode()) {
		...
		case 2:
			...
			break;
		case 3:
			$_SESSION['errhdr'] = 'Storing Authenticatieserver';
			$_SESSION['errhuman'] = 'De authenticatieserver (waarmee het klassenboek checkt of je wachtwoord juist is) is momenteel niet of slecht bereikbaar. Probeer de authenticatieserver te omzeilen door in te loggen met je afkorting ipv. je schoollogin. Dit werkt alleen als je al eens eerder ingelogd bent.';

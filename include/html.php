<?
function gen_html_header($title = NULL, $jquery = NULL, $stupid = '') { 
	global $favicon, $http_path, $schoolnaam, $load_time, $week; ?>
...
<? 
if ($stupid != '') {
	?><li>Klassenboek van <? echo(htmlentities($stupid)); ?></li><li><a href="http://rooster.ovc.nl/?q=<? echo($stupid); ?>&amp;week=<? echo($week) ?>">roosterbord</a></li>
<li><a href="https://abvo.itslearning.com/">It's Learning</a></li>
<li><a href="https://onlineklassenboek.nl/ovc/">ONLINEKLASSENBOEK</a></li>
<!--<li><a href="http://www.ovc.nl/">website OVC</a></li>-->
<?
} else if (!isset($_SESSION['ppl_id']) || $load_time - $_SESSION['last_load_time'] > 60*$_SESSION['timeout']) { ?>
<li<? if ($title == "Inloggen") { ?> class="active"<? }?>><a href="<?
	echo($http_path) ?>/?lock_by=">ONLINEKLASSENBOEK</a></li>
<li><a href="https://abvo.itslearning.com/">It's Learning</a></li>
<li><a href="http://rooster.ovc.nl/">Roosterbord</a></li>

...
//if ($_SESSION['type'] != 'leerling' && $_SESSION['type'] != 'ouder' && strlen($_SESSION['login']) == 4) return $_SESSION['login'];
if ($_SESSION['type'] != 'ouder') return $_SESSION['login'];
...
function get_rooster_link() {
	if ($id = get_rooster_id()) {
		$ref=3;
		if ($_SESSION['type'] == 'leerling') $ref=2;
		...
		//echo('">'.$id.'</a>');
		//echo('rooster van <a href="http://intranet.ovc.nl/rooster/infoweb/index.php?ref='.$ref.'&id='.$id.'" onClick="');
		//echo("window.open('http://intranet.ovc.nl/rooster/infoweb/index.php?ref=$ref&id=$id', 'rooster', 'width=680,height=512'); return false");
		echo(' <a href="http://rooster.ovc.nl/?q='.$id.'" onClick="');
		echo("window.open('http://rooster.ovc.nl/?q=$id', 'rooster'); return false");
		//echo("window.open('http://rooster.ovc.nl/?q=$id', 'rooster', 'width=1024,height=512'); return false");
		echo('">roosterbord</a>');
	}
} ?>

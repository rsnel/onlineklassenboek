...
SELECT CONCAT(IF(count = 1, grp_type_baas_ev, grp_type_baas_mv), ': ', id) AS `functie: perso(o)n(en)`,
	...
	SELECT GROUP_CONCAT(CONCAT(KB_NAAM(meerdere.naam0, CONCAT(SUBSTR(meerdere.naam1, 1, 1), '.'), meerdere.naam2), IF(meerdere.email LIKE '%%_%%', CONCAT(' &lt;', meerdere.email, '&gt;'), '')) SEPARATOR ', ') id,
...
<? if (isset($fun_facts)) echo($fun_facts); ?>

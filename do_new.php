...
if (isset($_POST['per']) && ($_POST['per'] == 'per1' ||$_POST['per'] == 'per2' || $_POST['per'] == 'per3')) {
...
if (mysql_numrows($result) && isset($_POST['teletop']) && $_POST['teletop'] == 'yes') add_to_teletop($grp2vak_id, $notitie_id, $week, $dag, $lesuur.'e uur: '.bbtohtml(
	                                htmlspecialchars($_POST['text'], ENT_QUOTES, 'UTF-8')).$tags, $sa);
else if (isset($_POST['teletop']) && $_POST['teletop'] == 'yes')

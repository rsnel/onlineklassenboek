...
if (isset($_GET['email']) && filter_var($_GET['email'], FILTER_VALIDATE_EMAIL)) $row['email'] = $_GET['email'];
if (isset($_GET['timeout']) && $timeouts[$_GET['timeout']]) $row['timeout'] = $_GET['timeout'];
